...
export default class StackView extends React.Component<Props, State> {
    static getDerivedStateFromProps(props: Readonly<Props>, state: Readonly<State>): {
        ...
        routes: (Route<string> & {
            state?: import("@react-navigation/routers/lib/typescript/src/types").NavigationState | import("@react-navigation/routers/lib/typescript/src/types").PartialState<import("@react-navigation/routers/lib/typescript/src/types").NavigationState> | undefined;
        })[];
        previousRoutes: (Route<string> & {
            state?: import("@react-navigation/routers/lib/typescript/src/types").NavigationState | import("@react-navigation/routers/lib/typescript/src/types").PartialState<import("@react-navigation/routers/lib/typescript/src/types").NavigationState> | undefined;
        })[];
